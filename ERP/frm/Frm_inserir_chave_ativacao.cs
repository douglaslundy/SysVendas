...
namespace ERP.frm
{
    public partial class Frm_inserir_chave_ativacao : Form
    {
        Frm_tela_de_bloqueio info;
        public Frm_inserir_chave_ativacao(Frm_tela_de_bloqueio telaInfo)
        {
            info = telaInfo;
            InitializeComponent();
        }
        ...
        private void Frm_inserir_chave_ativacao_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.Escape:
